 ...
 */
public class BuildRegressionModels extends Job {
	...
	public static void main(String[] args) throws Exception {
		Job job = new BuildRegressionModels(args[0],args[1]);
	...
	public BuildRegressionModels(String inputBucket, String outputBucket) {
		super();
